...
export const ALL_DOC_PAGES: DocPage[] = [
  ...
  // Capabilities
  { slug: "features/booking-builder", title: "فرم‌ساز رزرو", section: "قابلیت‌ها" },
  { slug: "features/marketplace", title: "بازارگاه و فهرست", section: "قابلیت‌ها" },
  { slug: "features/customer-dashboard", title: "داشبورد مشتری", section: "قابلیت‌ها" },
  { slug: "features/reviews", title: "نظرات و امتیاز", section: "قابلیت‌ها" },
  { slug: "features/provider-registration", title: "ثبت‌نام ارائه‌دهنده", section: "قابلیت‌ها" },
  { slug: "features/waitlist", title: "لیست انتظار", section: "قابلیت‌ها" },
  { slug: "features/analytics", title: "تحلیل قیف", section: "قابلیت‌ها" },
  { slug: "features/woocommerce", title: "پرداخت با ووکامرس", section: "قابلیت‌ها" },
  { slug: "features/deposits", title: "پیش‌پرداخت", section: "قابلیت‌ها" },
  { slug: "features/embeddable-widget", title: "ویجت جاسازی", section: "قابلیت‌ها" },
  // Configuration
  ...
  { slug: "integrations/smsir", title: "SMS.ir", section: "یکپارچگی‌ها" },
  { slug: "integrations/farazsms", title: "FarazSMS", section: "یکپارچگی‌ها" },
...
export function buildSidebarGroups(): DocsSidebarGroup[] {
  return [
    ...
    },
    {
      title: "قابلیت‌ها",
      items: [
        { href: "/docs/features/booking-builder", label: "فرم‌ساز رزرو" },
        { href: "/docs/features/marketplace", label: "بازارگاه و فهرست" },
        { href: "/docs/features/customer-dashboard", label: "داشبورد مشتری" },
        { href: "/docs/features/reviews", label: "نظرات و امتیاز" },
        { href: "/docs/features/provider-registration", label: "ثبت‌نام ارائه‌دهنده" },
        { href: "/docs/features/waitlist", label: "لیست انتظار" },
        { href: "/docs/features/analytics", label: "تحلیل قیف" },
        { href: "/docs/features/woocommerce", label: "پرداخت با ووکامرس" },
        { href: "/docs/features/deposits", label: "پیش‌پرداخت" },
        { href: "/docs/features/embeddable-widget", label: "ویجت جاسازی" },
      ],
    },
    {
      title: "تنظیمات",
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/docs/integrations/smsir", label: "SMS.ir" },
        { href: "/docs/integrations/farazsms", label: "FarazSMS" },
